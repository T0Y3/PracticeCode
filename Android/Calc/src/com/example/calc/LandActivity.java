...
public class LandActivity extends Activity{
	...
	Button button_E;
	Button button_Caret;
	Button button_LBracket;
	Button button_RBracket;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_2=(Button)findViewById(R.id.button1);
        button_3=(Button)findViewById(R.id.button2);
        ...
        button_Add=(Button)findViewById(R.id.button12);
        button_Sub=(Button)findViewById(R.id.button13);
        button_Mul=(Button)findViewById(R.id.button14);
        button_Div=(Button)findViewById(R.id.button15);
        
        button_Sin=(Button)findViewById(R.id.button16);
        button_Cos=(Button)findViewById(R.id.button17);
        button_Tan=(Button)findViewById(R.id.button18);
        button_E=(Button)findViewById(R.id.button19);
        button_Caret=(Button)findViewById(R.id.button21);
        button_LBracket=(Button)findViewById(R.id.Button02);
        button_RBracket=(Button)findViewById(R.id.Button03);
        
        button_Equ=(Button)findViewById(R.id.button20);
        button_Clr=(Button)findViewById(R.id.Button01);
    ...
    public void initBaseOpers() {
        ...
        button_Clr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                textView_Expr.setText(mathExpr);
                textView_Result.setText(mathResult);
                Toast.makeText(LandActivity.this, "Clear", Toast.LENGTH_SHORT).show();
            }
        });
	}
    ...
    public void initScienceOpers(){
        ...
        button_Caret.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if (mathExpr.length() > 0) {
                    char ch = mathExpr.charAt(mathExpr.length() - 1);
                    if (isNum(ch) || ch == ')' || ch == 'e' || ch == '¦Ð')
                    	mathExpr += "^(";
                }
                textView_Expr.setText(mathExpr);
            }
